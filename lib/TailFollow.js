...
import SplitStream from "./SplitStream.js"

export default class TailFollow extends Readable {
  static createSplitStream (filePath, opts={}) {
    opts.objectMode = true
    const tail = new TailFollow(filePath, opts)
    return tail.pipe(new SplitStream(tail, opts))
  }
